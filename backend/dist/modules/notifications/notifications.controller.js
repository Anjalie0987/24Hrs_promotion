...
let NotificationsController = class NotificationsController {
    ...
    async getNotifications(req, skip, take) {
        const skipVal = skip ? parseInt(skip, 10) : 0;
        const takeVal = take ? parseInt(take, 10) : 20;
        return this.notificationsService.getUserNotifications(req.user.userId, skipVal, takeVal);
    }
    ...
    async deleteReadNotifications(req) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], NotificationsController.prototype, "deleteReadNotifications", null);
__decorate([
