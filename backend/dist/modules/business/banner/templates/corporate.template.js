...
async function drawOwnerCard(ctx, data, startY) {
    ...
    drawContactItem(ctx, 'phone', data.whatsapp || '+1 234 567 890', textX, textY, contactW);
    drawContactItem(ctx, 'globe', data.website || 'No Website', textX + contactW, textY, contactW);
    drawContactItem(ctx, 'location', data.location || 'Location Not Set', textX + contactW * 2, textY, contactW);
    return startY + cardH;
}
